...
%stessa partita di andata e ritorno nella stessa giornata.
:- partita_andata(Girone, Squadra1,Squadra2, N),  partita_ritorno(Girone, Squadra1, Squadra2, N).

% Scartare tutti gli answer set in cui c'è una squadra in comune (INTEGRITY CONSTRAINT).
...
%  Scartare tutti gli answer set in cui una partita di andata viene disputata come una partita di ritorno.
:- partita_andata(Girone, Squadra1,Squadra2, N), partita_andata(Girone, Squadra2, Squadra1, N1), N != N1.

%Scartare tutti gli answer set in cui due squadre della stessa citta giocanoin casa nella stessa giornata.
:- partita_andata( _, Squadra1, _, N), partita_andata( _, Squadra2, _, N), uguale_citta(Squadra1, Squadra2).

%Una squadra non puo giocare più di due squadre in casa o in trasferta consecutivamente.
%:- partita_andata(_, Squadra1, _, Giornata1), partita_andata(_, Squadra1, _, Giornata2), partita_andata(_, Squadra1, _, Giornata3),
